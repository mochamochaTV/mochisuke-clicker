...
import { MYROOM_SLOT_POSITIONS, stages } from './data.js?v=2026-09-13-012';
import {
  ...
  slotTotalPulls
} from './minigames.js?v=2026-09-13-012';
import {
...
import {
  ...
  setLastGiftSentDates, setSeenButtonHints
        ...
        const CONFIG = {
            PLAYER_NAME_MAX_LENGTH: 8,             // プレイヤー名として受け付ける最大文字数（ランキング等での表示崩れ防止のため8文字に制限）
