...
import { ARCADE_CABINET_PARTS, stages } from '../../data.js?v=2026-09-17-018';
import {
...
import { currentStageIndex, getMinigameDailyLimit, prestigeShopLv, trackMissionEvent } from '../../progress.js?v=2026-09-17-018';
import { saveGame } from '../../state.js?v=2026-09-17-018';
import { getMps } from '../../tap.js?v=2026-09-17-018';
import { closeModal, getLocalDateString, openModal, openMoveMenu, updateDisplay } from '../../ui.js?v=2026-09-17-018';
import { startQuizGame } from './quiz.js?v=2026-09-17-018';
import { startTimeAttackGame, cleanupTimeAttackTimer } from './timeAttack.js?v=2026-09-17-018';
import { startConcentrationGame } from './concentration.js?v=2026-09-17-018';
import { startMochitsukiGame, cleanupMochitsukiTimer } from './mochitsuki.js?v=2026-09-17-018';
import { startSlotGame, cleanupSlotSpinState } from './slotMachine.js?v=2026-09-17-018';
