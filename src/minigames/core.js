...
import { ARCADE_CABINET_PARTS, stages } from '../../data.js?v=2026-09-13-006';
import {
  IS_DEV_MODE, PRESENT_REWARD_DISTANCE_RATE, PRESENT_REWARD_MIN, PRESENT_REWARD_MPS_RATE,
  playAudioFile, playBgmLoop
} from '../../main.js?v=2026-09-13-006';
import { currentStageIndex, getMinigameDailyLimit, prestigeShopLv, trackMissionEvent } from '../../progress.js?v=2026-09-13-006';
import { saveGame } from '../../state.js?v=2026-09-13-006';
import { getMps } from '../../tap.js?v=2026-09-13-006';
import { closeModal, getLocalDateString, openModal, openMoveMenu, updateDisplay } from '../../ui.js?v=2026-09-13-006';
import { startQuizGame } from './quiz.js?v=2026-09-13-006';
import { startTimeAttackGame, cleanupTimeAttackTimer } from './timeAttack.js?v=2026-09-13-006';
import { startConcentrationGame } from './concentration.js?v=2026-09-13-006';
import { startMochitsukiGame, cleanupMochitsukiTimer } from './mochitsuki.js?v=2026-09-13-006';
import { startSlotGame, cleanupSlotSpinState } from './slotMachine.js?v=2026-09-13-006';
