...
import { stages } from '../../data.js?v=2026-09-14-005';
import { playAudioFile, screenFlash, spawnModalParticleBurst, vibrate } from '../../main.js?v=2026-09-14-005';
import { currentStageIndex } from '../../progress.js?v=2026-09-14-005';
import { saveGame } from '../../state.js?v=2026-09-14-005';
import { consumeMinigamePlay, endMinigameToTiles, grantMinigameReward, minigameBests, showMinigameResult } from './core.js?v=2026-09-14-005';
