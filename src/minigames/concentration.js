...
import { stages } from '../../data.js?v=2026-09-17-014';
import { playAudioFile, screenFlash, spawnModalParticleBurst, vibrate } from '../../main.js?v=2026-09-17-014';
import { currentStageIndex } from '../../progress.js?v=2026-09-17-014';
import { saveGame } from '../../state.js?v=2026-09-17-014';
import { consumeMinigamePlay, endMinigameToTiles, grantMinigameReward, minigameBests, showMinigameResult } from './core.js?v=2026-09-17-014';
