        ...
        import { DEFAULT_MOUTH_POSITION, KISEKAE_CATEGORY_LABELS, KISEKAE_ITEMS, MYROOM_MOCHISUKE_SIZE } from '../../data.js?v=2026-09-17-020';
        import { IS_DEV_MODE, playAudioFile } from '../../main.js?v=2026-09-17-020';
        // 🧪 管理者限定・試作中：全身の「スクイーズ衣装」を装備/解除するたびに、スクイーズの音の素材を
        // 同期させるために使う（applyKisekaeToMainScreen参照）
        import { setAccumulateModeActive, setSqueezeMaterial } from '../squeeze/physics.js?v=2026-09-17-020';
        import { DEFAULT_SQUEEZE_MATERIAL_KEY } from '../squeeze/materials.js?v=2026-09-17-020';
        import { equippedKisekae, ownedKisekaeItems, previewKisekae, setEquippedKisekae, setPreviewKisekae } from '../../progress.js?v=2026-09-17-020';
        import { setActiveSprayId, setSprayBuffActiveUntil, sprayInventory } from '../../shop.js?v=2026-09-17-020';
        import { saveGame } from '../../state.js?v=2026-09-17-020';
        import { closeModal, openModal } from './core.js?v=2026-09-17-020';
        import { openTicketInventory } from './myroom.js?v=2026-09-17-020';
        import { updateDisplay, updateSprayEffectDisplay } from './hud.js?v=2026-09-17-020';
