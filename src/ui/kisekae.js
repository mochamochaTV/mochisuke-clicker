        ...
        import { DEFAULT_MOUTH_POSITION, KISEKAE_CATEGORY_LABELS, KISEKAE_ITEMS, MYROOM_MOCHISUKE_SIZE } from '../../data.js?v=2026-09-13-003';
        import { IS_DEV_MODE, playAudioFile } from '../../main.js?v=2026-09-13-003';
        import { equippedKisekae, ownedKisekaeItems, previewKisekae, setEquippedKisekae, setPreviewKisekae } from '../../progress.js?v=2026-09-13-003';
        import { setActiveSprayId, setSprayBuffActiveUntil, sprayInventory } from '../../shop.js?v=2026-09-13-003';
        import { saveGame } from '../../state.js?v=2026-09-13-003';
        import { closeModal, openModal } from './core.js?v=2026-09-13-003';
        import { openTicketInventory } from './myroom.js?v=2026-09-13-003';
        import { updateDisplay, updateSprayEffectDisplay } from './hud.js?v=2026-09-13-003';
