        ...
        import { SPRAY_ITEMS, dialogueData, stages } from '../../data.js?v=2026-09-17-017';
        import { createFloatingText, createParticle, formatMochi, lazyLoadImage, pickRandom, playAudioFile, screenFlash, screenShake, vibrate } from '../../main.js?v=2026-09-17-017';
        import { hasNewlyUnlockedMinigame } from '../../minigames.js?v=2026-09-17-017';
        import { canPrestige, collectedStamps, currentStageIndex, currentStageProgress, isPendingStampMoment, selectedStageIndex, setSelectedStageIndex, setStampDebugInterval, setStampDebugMode, stageArrivalTime, stampDebugInterval, stampDebugMode, trackMissionEvent, triggerAreaTransition } from '../../progress.js?v=2026-09-17-017';
        import { activeSprayId, getOmiyagePrice, purchasedItems, sprayBuffActiveUntil } from '../../shop.js?v=2026-09-17-017';
        import { saveGame, score } from '../../state.js?v=2026-09-17-017';
        import { FEED_BUFF_DURATION_MS, FEED_DAILY_LIMIT, feedPlaysUsedToday, feedTeaseTimer, feverTimeLeft, getMps, getTapPower, isFever, isScreamActive, mochiBtnElement, placeFeedIconNearMochisuke, resetFeedCountIfNewDay, revertScreamFace, setFeedBuffActiveUntil, setFeedPlaysUsedToday, setFeedTeaseLevel, skills, startFeedBuffIndicator } from '../../tap.js?v=2026-09-17-017';
        import { closeModal, isTutorialActive, openModal, showMochiComment } from './core.js?v=2026-09-17-017';
        import { isMochisukeVisible } from './kisekae.js?v=2026-09-17-017';
        import { diaryPageIndex } from './ranking.js?v=2026-09-17-017';
