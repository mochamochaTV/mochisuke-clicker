        ...
        import { escapeHtml, playAudioFile } from '../../main.js?v=2026-09-14-001';
        import { equippedKisekae, equippedMyroom } from '../../progress.js?v=2026-09-14-001';
        import { closeModal, openModal } from './core.js?v=2026-09-14-001';
        import { applyRemoteRoomAction, applyVisitOutfit, applyVisitWalkTarget, closeVisitMyroom, lastAppliedOtherWalkTs, lastAppliedRoomActionTs, renderVisitMyroomLayout, setLastAppliedOtherWalkTs, setLastAppliedRoomActionTs, setVisitingUid, startVisitMochisukeWalk } from './social.js?v=2026-09-14-001';
