        ...
        import { escapeHtml, playAudioFile } from '../../main.js?v=2026-09-17-020';
        import { equippedKisekae, equippedMyroom } from '../../progress.js?v=2026-09-17-020';
        import { closeModal, openModal } from './core.js?v=2026-09-17-020';
        import { applyRemoteRoomAction, applyVisitOutfit, applyVisitWalkTarget, closeVisitMyroom, lastAppliedOtherWalkTs, lastAppliedRoomActionTs, renderVisitMyroomLayout, setLastAppliedOtherWalkTs, setLastAppliedRoomActionTs, setVisitingUid, startVisitMochisukeWalk } from './social.js?v=2026-09-17-020';
