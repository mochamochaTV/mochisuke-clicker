        ...
        import { KISEKAE_ITEMS, MOVE_MENU_PARTS, MYROOM_ITEMS, WAREHOUSE_ITEM_PARTS, stages } from '../../data.js?v=2026-09-17-014';
        import { escapeHtml, playAudioFile, playBgmLoop, spawnModalFloatingText, spawnModalParticleBurst, vibrate } from '../../main.js?v=2026-09-17-014';
        import { equippedKisekae, gachaCoins, setGachaCoins } from '../../progress.js?v=2026-09-17-014';
        import { blockedUserIds, favoriteFriendIds, purchasedItems, updateGachaCoinDisplay } from '../../shop.js?v=2026-09-17-014';
        import { saveGame } from '../../state.js?v=2026-09-17-014';
        import { closeModal, openModal, openTrophyRoom } from './core.js?v=2026-09-17-014';
        import { CHAT_SEND_COOLDOWN_MS, activeChatIsHost, activeChatOtherUid, activeChatRoomId, ensureChatEligibilityAnswered, joinFriendRoomAndChat, lastChatSendAt, myAvatarPrefix, openHostWaitingRoom, otherAvatarPrefix, setActiveChatIsHost, setActiveChatOtherUid, setActiveChatRoomId, setChatUiVisible, setLastChatSendAt, setMyAvatarPrefix, setOtherAvatarPrefix, setVisitActionButtonsForHosting, stopRoomSessionWatch } from './chat.js?v=2026-09-17-014';
        import { MYROOM_WALK_SPEED_PCT_PER_SEC, openTicketInventory } from './myroom.js?v=2026-09-17-014';
        import { openOmiyageCollection, updateDisplay } from './hud.js?v=2026-09-17-014';
        import { openDiary, renderRankOutfitPreviewHtml } from './ranking.js?v=2026-09-17-014';
        ...
        import { findFullbodySlotItem } from './kisekae.js?v=2026-09-17-014';
